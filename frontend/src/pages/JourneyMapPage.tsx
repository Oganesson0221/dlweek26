...
export const JourneyMapPage: React.FC = () => {
  ...
  const checkpointsArray = Array.isArray(course.checkpoints)
    ? course.checkpoints
    : [];
  ...
  try {
    ...
    const weakAreas = topicsArray.filter(
      (t) => !t.completed && t.mastery < 50,
    ).length;
        ...
        <div className="relative z-10 space-y-8 max-w-7xl mx-auto pb-20 selection:bg-indigo-100 py-8 px-4">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="inline-flex items-center gap-2 backdrop-blur-md bg-white/80 p-2 rounded-xl border border-white/50 shadow-lg">
              ...
              <span className="text-[12px] font-bold text-slate-600 min-w-[3rem] text-center">
                {zoom}%
              </span>
              <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div
                  className={`rounded-xl p-5 border shadow-lg ${weakAreas > 0 ? "backdrop-blur-md bg-rose-50/80 border-rose-200/50" : "backdrop-blur-md bg-emerald-50/80 border-emerald-200/50"}`}
                >
                  <p
                    className="text-[11px] font-bold uppercase tracking-widest mb-2"
                    style={{ color: weakAreas > 0 ? "#b91c1c" : "#15803d" }}
                  >
                    {weakAreas > 0 ? "Weak Areas" : "On Track"}
                  </p>
                  <motion.p
                    className="text-[24px] font-black"
                    style={{ color: weakAreas > 0 ? "#991b1b" : "#166534" }}
                  >
                    {weakAreas}
                  </motion.p>
                  {weakAreas > 0 && (
                    <p className="text-[11px] mt-2 text-rose-700">
                      Need reinforcement
                    </p>
                  )}
                </div>
              ...
              <div className="backdrop-blur-md bg-white/80 rounded-xl border border-white/50 p-8 shadow-lg relative overflow-hidden group">
                ...
                <h3 className="text-[20px] font-black text-slate-900 mb-8">
                  Course Route Map
                </h3>
                      ...
                      return (
                        ...
                        >
                          <div className="flex flex-col items-center -translate-x-1/2 -translate-y-1/2">
                            ...
                            >
                              <p
                                className={`text-[11px] font-bold leading-tight max-w-[100px] ${
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-[16px] font-black text-slate-900 mb-5">
                  Grade Breakdown
                </h3>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-4">
                      <div
                        className={`w-10 h-10 rounded-2xl flex items-center justify-center ${urgency ? "bg-rose-100" : "bg-slate-100"}`}
                      >
                        <Clock
                          className={`w-5 h-5 ${urgency ? "text-rose-600" : "text-slate-600"}`}
                        />
                      </div>
                      <div>
                        <p
                          className={`text-[10px] font-black uppercase tracking-widest ${urgency ? "text-rose-600" : "text-slate-400"}`}
                        >
                          {urgency ? "Due Soon" : "Next"}
                        </p>
                        <h3
                          className={`text-[14px] font-black ${urgency ? "text-rose-900" : "text-slate-900"}`}
                        >
                          {next.name}
                        </h3>
                      </div>
                    ...
                    <p
                      className={`text-[12px] mb-3 ${urgency ? "text-rose-700" : "text-slate-600"}`}
                    >
                      {next.description}
                    </p>
                    <div
                      className={`flex items-center gap-2 text-[11px] font-bold ${urgency ? "text-rose-600" : "text-slate-600"}`}
                    >
...
function CheckpointDetail({
  ...
  return (
    <>
      <div className="flex items-start justify-between mb-4">
        <h4 className="text-[14px] font-black text-slate-900">{cp.name}</h4>
        <button
          onClick={onClose}
          className="text-slate-400 hover:text-slate-600 text-lg leading-none"
        >
      ...
      <div className="space-y-3">
        <div
          className={`rounded-lg p-3 border ${urgency ? "bg-rose-50 border-rose-200" : "bg-blue-50 border-blue-200"}`}
        >
          <div className="flex items-center justify-between mb-2">
            <span
              className={`text-[9px] font-black uppercase tracking-widest ${urgency ? "text-rose-600" : "text-blue-600"}`}
            >
              {urgency ? "Due Soon" : "Days Until"}
            </span>
            <span
              className={`text-[16px] font-black ${urgency ? "text-rose-600" : "text-blue-600"}`}
            >
              {daysLeft}
            </span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
            ...
            <p className="text-[12px] font-black text-slate-900 mt-1 capitalize">
              {cp.type}
            </p>
          </div>
          <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
